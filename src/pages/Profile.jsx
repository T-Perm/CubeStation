...
const USER_DATA = {
    ...
    achievements: [
        { name: "Sub-5 3x3", icon: Trophy, color: "text-rubik-yellow" },
        { name: "Daily Streak x30", icon: Activity, color: "text-rubik-red" },
        { name: "Peer Coach", icon: ShieldCheck, color: "text-rubik-blue" },
    ],
    records: {
        bestGlobal: "12th",
        bestLocal: "2nd",
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex flex-wrap gap-4">
                                {USER_DATA.achievements.map((ach, i) => {
                                    const { icon: Icon } = ach;
                                    return (
                                        <div key={ach.name} className="flex flex-col items-center gap-2 group">
                                            <div className="w-20 h-20 bg-white/5 dark:bg-black/20 backdrop-blur-md rounded-[1.5rem] border border-zinc-200/50 dark:border-white/10 flex items-center justify-center shadow-lg group-hover:scale-110 transition-all duration-300 relative overflow-hidden">
                                                <div className={cn("absolute inset-0 opacity-0 group-hover:opacity-20 blur-xl transition-opacity", ach.color.replace('text', 'bg'))} />
                                                <Icon className={cn("w-8 h-8 relative z-10", ach.color)} />
                                            </div>
