    ...
    return (
        <section ref={containerRef} className="relative min-h-[90vh] flex flex-col items-center justify-center pt-20 pb-32 px-4 overflow-hidden pointer-events-none">
            ...
            >
                ...
                >
                    <Button size="xl" className="group relative overflow-hidden bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 font-bold px-10 h-16 rounded-2xl shadow-2xl hover:scale-105 transition-all">
